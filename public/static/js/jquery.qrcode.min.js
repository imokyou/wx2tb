    ...
    $.fn.qrcode = function (options) {
        ...
        var createCanvas = function () {
            ...
            if (options.imgsrc) {//传进来的图片地址
                ...
                var maxImgW = (options.width - (options.margin * 2)) * 0.4,
                    maxImgH = (options.height - (options.margin * 2)) * 0.3;
                ...
                img.onload = function () {
                    ...
                    options.onload && options.onload.call($this,canvas);
                }
            }
        ...
        return this.each(function () {
            var element = options.render == "canvas" ? createCanvas.call(this) : createTable();
            $(element).appendTo(this);
            options.imgsrc || (options.render == "canvas"&&options.onload&&options.onload.call(this,element));
        });
    };
})(jQuery);
